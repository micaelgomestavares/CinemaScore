...
interface CommandSearchProps {
  ...
  onSelect: (data: any, type: string) => void;
}

const WatchListCommandSearch: React.FC<CommandSearchProps> = ({ open, onOpenChange, onSelect }) => {
...
export default WatchListCommandSearch;
